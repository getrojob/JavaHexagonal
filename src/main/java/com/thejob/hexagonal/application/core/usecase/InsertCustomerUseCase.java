package com.thejob.hexagonal.application.core.usecase;
...
import com.thejob.hexagonal.application.ports.out.FindAddressByZipCodeOutputPort;
import com.thejob.hexagonal.application.ports.out.InsertCustomerOutputPort;
import com.thejob.hexagonal.application.ports.out.SendCpfForValidationOutputPort;
